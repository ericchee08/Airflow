...
# Subclass for CSV data cleaning
class CsvCleaner(DataCleaner):
    pass  # Inherits behavior as-is

# Subclass for API data cleaning with consistent behavior
class ApiCleaner(DataCleaner):
    def clean_missing_values(self, data):
        # Custom but consistent: Replace missing values with "Unknown" instead of dropping rows
